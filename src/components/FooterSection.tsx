...
const FooterSection = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 py-8 sm:py-10 lg:py-12 px-4">
          ...
          <div className="text-center lg:text-right">
            ...
            <div className="space-y-2 sm:space-y-2.5">
              <a 
                ...
                className="flex items-center justify-center lg:justify-end gap-2 text-slate-400 hover:text-white transition-colors text-xs sm:text-sm"
              >
