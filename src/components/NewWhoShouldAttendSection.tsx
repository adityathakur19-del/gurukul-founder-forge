...
const NewWhoShouldAttendSection = () => {
  ...
  const notFor = ["Looking for a quick fix without putting in the work", "Can't dedicate 2 full days to your startup foundation", "Not ready to apply proven frameworks after the workshop"];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="space-y-6">
                ...
                return <div key={index} className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-soft hover:shadow-warm transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="space-y-8 animate-fade-in-up delay-300">
              ...
              <div className="space-y-4">
                {notFor.map((item, index) => <div key={index} className="flex items-start space-x-4 p-6 bg-muted/50 rounded-xl border border-startup-gray/20">
              ...
              <div className="bg-gradient-to-r from-saffron/10 to-deep-saffron/10 rounded-xl p-6 border border-saffron/20">
                ...
                <p className="text-muted-foreground text-sm">Our frameworks work for tech, non-tech, service, product, B2B, and B2C businesses.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <Button size="lg" className="bg-gradient-to-r from-green-accent to-startup-blue hover:from-startup-blue hover:to-green-accent text-white px-8 py-6 text-lg" onClick={redirectToPayment}>
