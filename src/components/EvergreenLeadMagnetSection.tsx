      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="relative animate-fade-in-up order-1 lg:order-2" style={{ animationDelay: "0.2s" }}>
            <div className="bg-gradient-to-br from-warm-white to-muted/50 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 border border-saffron/20 shadow-warm">
              {/* Toolkit Visual */}
              <div className="relative">
                {/* Main PDF visual */}
                <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 border border-border/50 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-saffron/10 rounded-lg flex items-center justify-center">
                ...
                {/* Floating elements */}
                <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 bg-saffron text-white rounded-full w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shadow-lg">
                  <span className="text-[10px] sm:text-xs font-bold text-center leading-tight">FREE<br/>Download</span>
                </div>

                <div className="absolute -bottom-2 -left-2 sm:-bottom-3 sm:-left-3 bg-white rounded-lg shadow-md p-2 sm:p-3 border border-border/50 transform -rotate-3">
