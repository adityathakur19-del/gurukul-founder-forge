          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex justify-between space-x-2">
                <div className="text-center p-4 bg-gradient-to-br from-green-accent/10 to-startup-blue/10 rounded-xl border border-green-accent/20 px-[150px]">
                ...
                <div className="text-center p-4 bg-gradient-to-br from-guru-gold/10 to-saffron/10 rounded-xl border border-guru-gold/20 px-[150px]">
                  <div className="flex justify-center mb-2">
                ...
                <div className="text-center p-4 bg-gradient-to-br from-saffron/10 to-deep-saffron/10 rounded-xl border border-saffron/20 px-[150px]">
                  <div className="flex justify-center mb-2">
