      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Early-stage startup founders and startup leaders in India facing chaos, too many AI tools, no clear execution and inconsistent revenue.</p>
          </div>
