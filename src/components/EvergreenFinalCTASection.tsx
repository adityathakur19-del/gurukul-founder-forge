      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-5xl mx-auto space-y-8 sm:space-y-10 lg:space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            {/* Box 1 – Timer */}
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-5 sm:p-6 text-center hover:border-saffron/50 transition-colors">
              <Clock className="w-7 h-7 sm:w-8 sm:h-8 text-saffron mx-auto mb-2 sm:mb-3" />
              <h3 className="text-white font-semibold text-base sm:text-lg mb-2">Next Session In</h3>
              <div className="flex justify-center gap-1.5 sm:gap-2 text-lg sm:text-xl md:text-2xl font-bold text-saffron mb-2 sm:mb-3">
                <span className="bg-slate-900 px-1.5 sm:px-2 py-1 rounded text-sm sm:text-base md:text-xl">{timeLeft.days}d</span>
                <span className="text-slate-500">:</span>
                <span className="bg-slate-900 px-1.5 sm:px-2 py-1 rounded text-sm sm:text-base md:text-xl">{timeLeft.hours}h</span>
                <span className="text-slate-500">:</span>
                <span className="bg-slate-900 px-1.5 sm:px-2 py-1 rounded text-sm sm:text-base md:text-xl">{timeLeft.minutes}m</span>
                <span className="text-slate-500">:</span>
                <span className="bg-slate-900 px-1.5 sm:px-2 py-1 rounded text-sm sm:text-base md:text-xl">{timeLeft.seconds}s</span>
              </div>
            ...
            {/* Box 2 – Scarcity */}
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-5 sm:p-6 text-center hover:border-saffron/50 transition-colors">
              <Target className="w-7 h-7 sm:w-8 sm:h-8 text-saffron mx-auto mb-2 sm:mb-3" />
              <h3 className="text-white font-semibold text-base sm:text-lg mb-2">Less than 15 Seats Left</h3>
              <p className="text-slate-400 text-xs sm:text-sm mt-2 sm:mt-4">
                Small cohort → more personal feedback, sharper execution.
              </p>
            </div>

            {/* Box 3 – Price + Reserve */}
            <div className="bg-gradient-to-br from-saffron/20 to-deep-saffron/20 backdrop-blur-sm border border-saffron/30 rounded-xl p-5 sm:p-6 text-center sm:col-span-2 md:col-span-1">
              <CreditCard className="w-7 h-7 sm:w-8 sm:h-8 text-saffron mx-auto mb-2 sm:mb-3" />
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-saffron to-deep-saffron hover:from-deep-saffron hover:to-saffron text-white font-semibold py-2.5 sm:py-3"
              >
                Reserve My Seat
              </Button>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-800/80 border border-slate-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 shadow-2xl">
            ...
            <p className="text-center text-lg sm:text-xl md:text-2xl font-bold text-white mb-6 sm:mb-8 border-t border-slate-700 pt-6 sm:pt-8">
            ...
            <div className="flex justify-center">
              <Button 
                size="lg"
                onClick={handleReserveSeat}
                className="w-full sm:w-auto bg-gradient-to-r from-saffron to-deep-saffron hover:from-deep-saffron hover:to-saffron text-white px-8 sm:px-10 py-5 sm:py-6 text-base sm:text-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all group"
              >
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
              {/* Card 1 */}
              <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-5 sm:p-6 hover:border-saffron/50 transition-colors">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="p-2.5 sm:p-3 bg-saffron/10 rounded-lg flex-shrink-0">
                    <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-saffron" />
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-white font-semibold text-base sm:text-lg mb-1.5 sm:mb-2">
