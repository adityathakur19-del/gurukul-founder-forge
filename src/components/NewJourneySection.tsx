...
const NewJourneySection = () => {
  ...
  return <section className="py-20 bg-gradient-to-b from-green-accent/5 to-background">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              return <div key={index} className="relative bg-white rounded-2xl p-8 shadow-soft hover:shadow-warm transition-all duration-300 hover:-translate-y-2 animate-fade-in-up" style={{
          ...
          <div className="mt-16 bg-gradient-to-r from-startup-blue/10 to-green-accent/10 rounded-2xl p-8 border border-startup-blue/20">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">You'll leave the workshop with a crystal-clear 90-day execution roadmap.
If not, we'll work with you 1:1 after the session at no extra cost.</p>
            </div>
          </div>
        </div>
      </div>
